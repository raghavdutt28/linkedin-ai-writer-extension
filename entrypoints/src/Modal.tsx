...
const Modal: React.FC<ModalProps> = ({ lastFocusedDiv, onClose }) => {
    ...
    return (
        <div onClick={handleBackgroundClick} className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-20 transition duration-300 ease-in-out font-sans">
                ...
                {promptHistory.prompt ? (
                    <div className="space-y-4">
                        <div className='space-y-4 max-h-60 overflow-y-auto'>
                            <div className="space-y-4">
                                <div className="flex justify-end">
                                    <div className="bg-gray-100 text-gray-500 font-normal p-4 rounded-xl max-w-2xl w-full">
                                        {promptHistory.prompt}
                                    </div>
                                </div>
                                <div className="flex justify-start">
                                    <div style={{ backgroundColor: secondaryColor }} className="text-gray-500 font-normal p-4 rounded-xl max-w-2xl">
                                        {promptHistory.reply}
                                    </div>
                                </div>
                            </div>
                        ...
                        <input
                            ...
                            className='border border-gray-200 placeholder-gray-300 rounded-lg mt-2 w-full p-2 text-gray-500 font-medium placeholder:font-medium'
                            value={inputValue}
                        ...
                        <div className="flex justify-end gap-6">
                            <button
                                ...
                                className="w-min px-6 py-3 gap-2.5 text-gray-500 font-semibold border-2 border-gray-500 rounded-lg flex items-center text-2xl"
                            >
                            ...
                            <button
                                ...
                                className="w-min px-6 py-3 gap-2.5 text-white rounded-lg flex items-center text-2xl font-semibold"
                            >
                    ...
                    <>
                        ...
                        <button
                            onClick={handleGenerate}
                            style={{ backgroundColor: primaryColor }}
                            className="ml-auto w-min px-6 py-3 gap-2.5 text-white font-semibold rounded-lg flex items-center text-2xl"
                        >
